...
insert into employee (id, first_name, last_name, email) values (1, 'usha', 'las', 'usha.bird@gmail.com');
insert into employee (id, first_name, last_name, email) values (2, 'samo', 'sathi', 'samu.sathi@gmail.com');
insert into employee (id, first_name, last_name, email) values (3, 'great', 'learners', 'greatlearners@gmail.com');
